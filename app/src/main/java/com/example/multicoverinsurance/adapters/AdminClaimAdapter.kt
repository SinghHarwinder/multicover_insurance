...
import com.example.multicoverinsurance.ClaimDetailsActivity
...
class AdminClaimAdapter(
    private var list: MutableList<AdminClaims>,
    private val context: Context,
    private val calling: String
) : RecyclerView.Adapter<AdminClaimAdapter.ViewHolder>()  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        vh.card.setOnClickListener {
            ...
            val intent = Intent(context, ClaimDetailsActivity::class.java)
            intent.putExtra("claimDetail", policy)
